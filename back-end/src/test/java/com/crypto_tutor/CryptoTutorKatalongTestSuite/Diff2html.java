...
/**
 * this will test the diff2html functionality of the project
 * @author Tommy Nelson
 */
public class Diff2html {
  ...
  /**
   * tests the diff2html fucntionality by searching a question then inputting 1 3 for questions to compare 
   * @throws Exception
   */
  @Test
