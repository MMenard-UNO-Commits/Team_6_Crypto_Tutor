...
public class SearchQuestion {
  ...
  public void testSearchQuestion() throws Exception {
    ...
    driver.findElement(By.id("ID")).sendKeys("tdnelson");
    driver.findElement(By.xpath("//div[@id='root']/div/div/form/div[2]/input")).clear();
    driver.findElement(By.xpath("//div[@id='root']/div/div/form/div[2]/input")).sendKeys("1234");
    driver.findElement(By.id("question")).click();
    driver.findElement(By.id("question")).clear();
    driver.findElement(By.id("question")).sendKeys("test Katalon");
